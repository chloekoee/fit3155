...
class SuffixTree:
    ...
    def _phase(self, i: int):
        ...
        ## While there exists remaining suffixes to insert
        while self.remaining > 0:
            if self.active_length == 0:
                ...
                if edge is None:
                    ...
                    self.remaining -= 1
                else:  ## If an edge exists, then break from this phase
                ...
                try:
                    ...
                    ## Rule 2: Create new internal node; Split edge with new internal node and create new edge
                    else:
                        ...
                        ## Else stay at the root node, and decrement active length and increment active edge
                            ...
                            self.active_length -= 1
                            self.active_edge += (
                                1  ## By setting active_edge as the index
                            )
                        ...
                        ## Update last_internal_node
                        last_internal_node = internal_node

                ## If we are inserting at a node
    ...
    def active_point(self) -> "Edge":
        ...
        return self.active_node.search(self.text[self.active_edge])  # type: ignore
