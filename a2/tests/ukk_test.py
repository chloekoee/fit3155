...
class TestLCPS:
    ...
    def test_generate_suffix_tree_2(self):
        ...
        assert (
            len(edges[0].destination.filtered_edges[1].destination.filtered_edges) == 2
        )
        assert (
            edges[0].destination.filtered_edges[1].destination.filtered_edges[0].label
            == "ppi"
        )
        assert (
            edges[0]
        ...
        assert (
            edges[0].destination.filtered_edges[1].destination.filtered_edges[1].label
            == "ssippi"
        )
        assert (
            edges[0]
        ...
        assert (
            len(edges[3].destination.filtered_edges[0].destination.filtered_edges) == 2
        )
        assert (
            edges[3].destination.filtered_edges[0].destination.filtered_edges[0].label
            == "ppi"
        )
        assert (
            edges[3]
        ...
        assert (
            edges[3].destination.filtered_edges[0].destination.filtered_edges[1].label
            == "ssippi"
        )
        assert (
            edges[3]
        ...
        assert (
            len(edges[3].destination.filtered_edges[1].destination.filtered_edges) == 2
        )
        assert (
            edges[3].destination.filtered_edges[1].destination.filtered_edges[0].label
            == "ppi"
        )
        assert (
            edges[3]
        ...
        assert (
            edges[3].destination.filtered_edges[1].destination.filtered_edges[1].label
            == "ssippi"
        )
        assert (
            edges[3]
    ...
    def test_suffix_tree(self):
        ...
        assert (
            len(edges[2].destination.filtered_edges[0].destination.filtered_edges) == 0
        )
        ...
        assert (
            len(edges[2].destination.filtered_edges[1].destination.filtered_edges) == 2
        )
        assert (
            edges[2].destination.filtered_edges[1].destination.filtered_edges[0].label
            == "$"
        )
        assert (
            edges[2].destination.filtered_edges[1].destination.filtered_edges[0].start
            == 9
        )
        assert (
            int(
                edges[2].destination.filtered_edges[1].destination.filtered_edges[0].end
            )
            == 9
        )
        assert (
        ...
        assert (
            edges[2].destination.filtered_edges[1].destination.filtered_edges[1].label
            == "xyaxyz$"
        )
        assert (
            edges[2].destination.filtered_edges[1].destination.filtered_edges[1].start
            == 3
        )
        assert (
            int(
                edges[2].destination.filtered_edges[1].destination.filtered_edges[1].end
            )
            == 9
        )
        assert (
        ...
        assert (
            len(edges[3].destination.filtered_edges[0].destination.filtered_edges) == 0
        )
        ...
        assert (
            edges[3].destination.filtered_edges[1].destination.filtered_edges[0].start
            == 9
        )
        assert (
            int(
                edges[3].destination.filtered_edges[1].destination.filtered_edges[0].end
            )
            == 9
        )
        assert (
        ...
        assert (
            edges[3].destination.filtered_edges[1].destination.filtered_edges[1].start
            == 3
        )
        assert (
            int(
                edges[3].destination.filtered_edges[1].destination.filtered_edges[1].end
            )
            == 9
        )
        assert (
        ...
        assert (
            len(edges[4].destination.filtered_edges[0].destination.filtered_edges) == 0
        )
        ...
        assert (
            len(edges[4].destination.filtered_edges[1].destination.filtered_edges) == 0
        )
